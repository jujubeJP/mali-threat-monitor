// マリ共和国 治安インシデントデータ（2025年5月～2026年6月初頭）
// 出典: ACLED, Wikipedia, Al Jazeera, BBC, Bellingcat, ICCT, Soufan Center,
...
// 時系列フェーズ定義
// P1: 地方軍基地攻撃期      (2025年5-8月) — 大規模軍基地強襲・北部中心
// P2: 経済封鎖期            (2025年9月-2026年3月) — 燃料供給路遮断・西部広域化
// P3: 連携首都攻撃期        (2026年4月)              — JNIM+FLA協調・キダル陥落
// P4: 包囲・北部完全喪失期  (2026年5月-6月)          — バマコ封鎖強化・北部撤退完了

const phases = {
  P1: { label: "P1 軍基地攻撃期",      range: "2025年5-8月",       color: "#d62828" },
  P2: { label: "P2 経済封鎖期",        range: "2025年9月-2026年3月", color: "#f77f00" },
  P3: { label: "P3 連携首都攻撃期",    range: "2026年4月",          color: "#7209b7" },
  P4: { label: "P4 包囲・北部喪失期",  range: "2026年5月-6月",      color: "#2a9d8f" }
};

const incidents = [
  // =================== P1: 地方軍基地攻撃期 (2025年5-8月) ===================
  {
    id: 1, phase: "P1",
    date: "2025-05-23",
  ...
  },
  {
    ...
    fatalities: 15,
    summary: "Katiba Macina（JNIM支派）が西部8拠点を同時攻撃。州都Kayes市初攻撃、セネガル国境ディボリ検問所への史上最接近攻撃。インド人技術者3名拉致。",
  ...
  },
  {
    ...
    targetType: "military_base", group: "JNIM",
    fatalities: 21,
    summary: "JNIMがファラブグの軍駐屯地・村落を強襲・占領。車両15台・武器50挺以上奪取。以後JNIMが街を実効支配。",
  ...
  // =================== P2: 経済封鎖期 (2025年9月-2026年3月) ===================
  {
    ...
    fatalities: 0,
    summary: "JNIM報道官アル＝バンバリが燃料封鎖を宣言。セネガル・コートジボワール・ギニアから内陸マリへ陸路で燃料を運ぶタンクローリーが標的に。バマコ封鎖戦略の開始。",
  ...
  },
  {
    ...
    fatalities: 8,
    summary: "OCHAによれば、Ségou・Sikasso・TimbuktuでIED関連の人道アクセス制約が前月比155%増。民間人犠牲継続。",
  ...
  // =================== P3: 連携首都攻撃期 (2026年4月) ===================
  {
    ...
    fatalities: 16,
    summary: "未明5:20頃、Kati主要軍基地で2回の爆発と銃撃戦。自爆車両攻撃でマリ国防相サディオ・カマラ大将が死亡（暗殺）。Mamaribougou地区で戦闘継続。ロシア・アフリカ軍団傭兵が応戦。",
    source: "Wikipedia / Al Jazeera",
  ...
  },
  {
    ...
    fatalities: 0,
    summary: "バマコ国際空港近郊で激しい銃撃戦と爆発。発着便全便キャンセル。ヘリコプター3機が監視飛行。アフリカ軍団基地が攻撃対象に。",
  ...
  },
  {
    ...
    fatalities: 0,
    summary: "アザワド解放戦線（FLA）がキダルの大部分を制圧。州知事公邸にFLA戦闘員侵入の映像確認。マリ軍とロシア軍は旧MINUSMA基地に立てこもり。アフリカ軍団撤退合意でFLAが完全制圧。2023年11月の奪還以来初の失陥。",
    source: "Wikipedia / Al Jazeera",
    sourceUrl: "https://en.wikipedia.org/wiki/2026_Mali_attacks"
  },
  {
    ...
    fatalities: 0,
    summary: "ガオ市内で銃撃戦。FLA戦闘員が一部を制圧。マリ空軍Mi-35ヘリ（アフリカ軍団所属）撃墜、乗員と機動火力班全員死亡。",
    source: "Wikipedia / Al Jazeera",
    sourceUrl: "https://en.wikipedia.org/wiki/2026_Mali_attacks"
  },
  {
    ...
    targetType: "military_base", group: "JNIM",
    fatalities: 0,
    summary: "セバレ（モプティ近郊）でマリ陸軍駐屯地と空軍基地を強襲。JNIMが宣伝映像を6月6日に公開。",
  ...
  // =================== P4: 包囲・北部喪失期 (2026年5月-6月) ===================
  {
    ...
    fatalities: 0,
    summary: "アフリカ軍団がテッサリトから撤退、FLAが制圧。アルジェリアの仲介で「安全通行」保証。北部撤退ドミノの開始。",
  ...
  },
  {
    ...
    targetType: "withdrawal", group: "FLA",
    fatalities: 0,
    summary: "アゲルホクとアゲロク両基地から撤退完了。北部マリにおけるアフリカ軍団のプレゼンスが事実上消滅。",
    source: "Hollister Situation Report",
    sourceUrl: "https://www.michael-hollister.com/2026/05/29/update-mali-situation-report-29-may-2026/"
  },
  {
    ...
    targetType: "fuel_tanker", group: "JNIM",
    fatalities: 3,
    summary: "JNIMが軍護衛なしの民間トラック車列を放火攻撃。バマコ市場向け果物輸送が標的。バマコ・モプティでパン・米価格が2倍、輸送費が3倍に。Amnesty Internationalによれば5月15日までに首都への6本の幹線道路のうち3本が遮断。",
  ...
  },
  {
    ...
    fatalities: 0,
    summary: "JNIMが南部マリのケニエロバ中央刑務所（2,500人収容、JNIM戦闘員多数）を攻撃。捕虜解放作戦と推定。",
    source: "Hollister Situation Report",
    sourceUrl: "https://www.michael-hollister.com/2026/05/29/update-mali-situation-report-29-may-2026/"
  },
  {
    ...
    fatalities: 25,
    summary: "JNIMがドゾ民兵（Dan Na Ambassagou運動）への大攻勢を開始。Bandiagara・Bankass・Djenne各圏で展開。Gomossagou・Kori Kori・Dougara・Kourounde・Bougoulaで最も多数の死者。地元指導者複数を暗殺。",
  ...
  },
  {
    ...
    targetType: "civilian", group: "JNIM",
    fatalities: 0,
    summary: "JNIMによる「武装解除キャンペーン」開始。Bankass圏の村落12箇所がJNIMに武器を引き渡し。事実上の地域統治確立。",
    source: "ACLED",
    sourceUrl: "https://acleddata.com/update/africa-overview-june-2026"
  },
  {
    ...
    targetType: "withdrawal", group: "FLA",
    fatalities: 0,
    summary: "戦略的なIntahaka金鉱がマリ軍・ロシア軍からFLAに引き渡される。撤退協定の一部。北部の収益源喪失。",
    source: "Hollister Situation Report",
    sourceUrl: "https://www.michael-hollister.com/2026/05/29/update-mali-situation-report-29-may-2026/"
  },
  {
    ...
    targetType: "militia_conflict", group: "JNIM",
    fatalities: 18,
    summary: "ドゾ民兵への武装襲撃で集落2箇所が壊滅。死者数P4期で最多。",
    source: "ACLED",
    sourceUrl: "https://acleddata.com/update/africa-overview-june-2026"
  },
  {
    ...
    targetType: "militia_conflict", group: "JNIM",
    fatalities: 9,
    summary: "JNIMがセグー州にもドゾ民兵掃討を拡大。村落チェックポイントと移動制限を巡る対立が背景。",
    source: "ACLED",
    sourceUrl: "https://acleddata.com/update/africa-overview-june-2026"
  },
  {
    ...
    targetType: "civilian", group: "JNIM",
    fatalities: 8,
    summary: "バマコ・カイ幹線でバスがJNIM敷設の地雷に接触。8名死亡、42名負傷。Africa Corpsは死者5名以上・負傷10名超と報告。封鎖戦術のエスカレーション。",
  ...
  },
  {
    ...
    targetType: "blockade", group: "JNIM",
    fatalities: 0,
    summary: "マリ軍政がIyad Ag Ghaly（JNIM首領）に350万ドルの懸賞金。FLA幹部含む6名追加指名手配。同日、軍政はバイクの輸入・販売を1年間禁止（武装勢力の機動力封じ）。",
    source: "BBC",
...
const majorCities = [
  ...
  { name: "Kidal", lat: 18.4411, lng: 1.4078, role: "極北部州都（FLA制圧）" },
  { name: "Tessalit", lat: 20.1986, lng: 1.0114, role: "極北部基地（FLA制圧）" },
...
const targetTypes = {
  ...
  fuel_tanker:      { label: "燃料輸送車",       color: "#f77f00" },
  ...
  assassination:    { label: "要人暗殺",         color: "#ff006e" },
  withdrawal:       { label: "撤退・基地放棄",   color: "#2a9d8f" },
  militia_conflict: { label: "民兵抗争",         color: "#e85d75" },
  prison_break:     { label: "刑務所襲撃",       color: "#8338ec" }
};
